...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llp{8cm}@{}}
        ...
        & \texttt{lucide-react} & High-performance vector iconography. \\
        \midrule
        ...
        & \texttt{csv-parse} & Streams multidimensional raw string arrays into computable JSON floating-point matrices synchronously. \\
