...
\draw [arrow] (express) -- node[above, font=\scriptsize] {Native Call} (python);
\draw [arrow] (express) -- node[above, font=\scriptsize] {HTTPS Payload} (gemini);
\draw [dashedarrow] (python) to[bend right=40] node[below, font=\scriptsize] {Computed Array} (express);
